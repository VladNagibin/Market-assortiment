        ...
        <div className='delivery-order-block row'>
          ...
          <div className='col s7'>
            <div style={{ position: 'relative', overflow: 'hidden' }}>
              <iframe src="https://yandex.ru/map-widget/v1/?um=constructor%3A60e879870bf18ece26b5b2f6bd223b3f6d7ba0cadaaeb4f7f98706038a81cb7e&amp;source=constructor" width="500" height="400" frameborder="0"></iframe>
            </div>
          </div>
        </div>
      </div>
